...
/** ===========================================================================
 * 正規化デバイス座標系は、-1.0 ～ 1.0 の範囲を持つ座標系です。これは前述のとお
 * り、ウィンドウサイズ（正確には canvas のサイズ）がどうなっていたとしても、常
 * に一定です。
 * このサンプルでは、頂点が -1.0 ～ 1.0 の範囲に均等に敷き詰められた状態になるよ
 * うに、あらかじめ JavaScript 側で頂点座標を与えておきます。その既定の頂点座標
 * を受け取った頂点シェーダ側に様々なロジックを記述しながら、頂点シェーダの記述
 * や正規化デバイス座標系の感覚を養いましょう。
 * ========================================================================= */
...
class WebGLFrame {
    ...
    setup(){
        ...
        /**
         * 正規化デバイス座標系の XY 平面全体に、頂点を敷き詰めます。
